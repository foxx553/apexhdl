...
- ApexHDL supports PYNQ-Z2 target (`xc7z020clg400-1`), described in [TUL product specification](https://www.tulembedded.com/fpga/ProductsPYNQ-Z2.html), and uses Vivado Design Suite for synthesis.
