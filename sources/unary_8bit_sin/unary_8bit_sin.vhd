...
begin
    ...
    -- Unary core
	decoder_input(0) <= encoder_output(0) xor encoder_output(68);
	decoder_input(1) <= encoder_output(0) xor encoder_output(61) xor encoder_output(71);
	decoder_input(2) <= encoder_output(0) xor encoder_output(58) xor encoder_output(73);
	decoder_input(3) <= encoder_output(0) xor encoder_output(56) xor encoder_output(74);
	decoder_input(4) <= encoder_output(0) xor encoder_output(55) xor encoder_output(75);
	decoder_input(5) <= encoder_output(0) xor encoder_output(54) xor encoder_output(76);
	decoder_input(6) <= encoder_output(0) xor encoder_output(53) xor encoder_output(78);
	decoder_input(7) <= encoder_output(0) xor encoder_output(51) xor encoder_output(79);
	decoder_input(8) <= encoder_output(0) xor encoder_output(50) xor encoder_output(79);
	decoder_input(9) <= encoder_output(0) xor encoder_output(50) xor encoder_output(80);
	decoder_input(10) <= encoder_output(0) xor encoder_output(49) xor encoder_output(81);
	decoder_input(11) <= encoder_output(0) xor encoder_output(48) xor encoder_output(82);
	decoder_input(12) <= encoder_output(0) xor encoder_output(47) xor encoder_output(83);
	decoder_input(13) <= encoder_output(0) xor encoder_output(46) xor encoder_output(83);
	decoder_input(14) <= encoder_output(0) xor encoder_output(46) xor encoder_output(84);
	decoder_input(15) <= encoder_output(0) xor encoder_output(45) xor encoder_output(85);
	decoder_input(16) <= encoder_output(0) xor encoder_output(44) xor encoder_output(85);
	decoder_input(17) <= encoder_output(0) xor encoder_output(44) xor encoder_output(86);
	decoder_input(18) <= encoder_output(0) xor encoder_output(43) xor encoder_output(87);
	decoder_input(19) <= encoder_output(0) xor encoder_output(42) xor encoder_output(87);
	decoder_input(20) <= encoder_output(0) xor encoder_output(42) xor encoder_output(88);
	decoder_input(21) <= encoder_output(0) xor encoder_output(41) xor encoder_output(88);
	decoder_input(22) <= encoder_output(0) xor encoder_output(41) xor encoder_output(89);
	decoder_input(23) <= encoder_output(0) xor encoder_output(40) xor encoder_output(90);
	decoder_input(24) <= encoder_output(0) xor encoder_output(39) xor encoder_output(90);
	decoder_input(25) <= encoder_output(0) xor encoder_output(39) xor encoder_output(91);
	decoder_input(26) <= encoder_output(0) xor encoder_output(38) xor encoder_output(91);
	decoder_input(27) <= encoder_output(0) xor encoder_output(38) xor encoder_output(92);
	decoder_input(28) <= encoder_output(0) xor encoder_output(37) xor encoder_output(92);
	decoder_input(29) <= encoder_output(0) xor encoder_output(37) xor encoder_output(93);
	decoder_input(30) <= encoder_output(0) xor encoder_output(36) xor encoder_output(93);
	decoder_input(31) <= encoder_output(0) xor encoder_output(36) xor encoder_output(94);
	decoder_input(32) <= encoder_output(0) xor encoder_output(35) xor encoder_output(94);
	decoder_input(33) <= encoder_output(0) xor encoder_output(35) xor encoder_output(95);
	decoder_input(34) <= encoder_output(0) xor encoder_output(34) xor encoder_output(95);
	decoder_input(35) <= encoder_output(0) xor encoder_output(34) xor encoder_output(96);
	decoder_input(36) <= encoder_output(0) xor encoder_output(33) xor encoder_output(96);
	decoder_input(37) <= encoder_output(0) xor encoder_output(33) xor encoder_output(97);
	...
	decoder_input(40) <= encoder_output(0) xor encoder_output(32) xor encoder_output(98);
	decoder_input(41) <= encoder_output(0) xor encoder_output(31) xor encoder_output(98);
	decoder_input(42) <= encoder_output(0) xor encoder_output(31) xor encoder_output(99);
	decoder_input(43) <= encoder_output(0) xor encoder_output(30) xor encoder_output(99);
	decoder_input(44) <= encoder_output(0) xor encoder_output(30) xor encoder_output(100);
	...
	decoder_input(47) <= encoder_output(0) xor encoder_output(29) xor encoder_output(101);
	decoder_input(48) <= encoder_output(0) xor encoder_output(28) xor encoder_output(101);
	decoder_input(49) <= encoder_output(0) xor encoder_output(28) xor encoder_output(102);
	...
	decoder_input(52) <= encoder_output(0) xor encoder_output(27) xor encoder_output(103);
	decoder_input(53) <= encoder_output(0) xor encoder_output(26) xor encoder_output(103);
	decoder_input(54) <= encoder_output(0) xor encoder_output(26) xor encoder_output(104);
	...
	decoder_input(57) <= encoder_output(0) xor encoder_output(25) xor encoder_output(105);
	...
	decoder_input(60) <= encoder_output(0) xor encoder_output(24) xor encoder_output(106);
	decoder_input(61) <= encoder_output(0) xor encoder_output(23) xor encoder_output(106);
	decoder_input(62) <= encoder_output(0) xor encoder_output(23) xor encoder_output(107);
	...
	decoder_input(65) <= encoder_output(0) xor encoder_output(22) xor encoder_output(108);
	...
	decoder_input(68) <= encoder_output(0) xor encoder_output(21) xor encoder_output(109);
	decoder_input(69) <= encoder_output(0) xor encoder_output(20) xor encoder_output(109);
	decoder_input(70) <= encoder_output(0) xor encoder_output(20) xor encoder_output(110);
	...
	decoder_input(73) <= encoder_output(0) xor encoder_output(19) xor encoder_output(111);
	...
	decoder_input(76) <= encoder_output(0) xor encoder_output(18) xor encoder_output(112);
	...
	decoder_input(79) <= encoder_output(0) xor encoder_output(17) xor encoder_output(113);
	...
	decoder_input(82) <= encoder_output(0) xor encoder_output(16) xor encoder_output(114);
	...
	decoder_input(85) <= encoder_output(0) xor encoder_output(15) xor encoder_output(115);
	...
	decoder_input(88) <= encoder_output(0) xor encoder_output(14) xor encoder_output(116);
	...
	decoder_input(91) <= encoder_output(0) xor encoder_output(13) xor encoder_output(117);
	...
	decoder_input(94) <= encoder_output(0) xor encoder_output(12) xor encoder_output(118);
	...
	decoder_input(97) <= encoder_output(0) xor encoder_output(11) xor encoder_output(119);
	...
	decoder_input(100) <= encoder_output(0) xor encoder_output(10) xor encoder_output(120);
	...
	decoder_input(103) <= encoder_output(0) xor encoder_output(9) xor encoder_output(121);
	...
	decoder_input(106) <= encoder_output(0) xor encoder_output(8) xor encoder_output(122);
	...
	decoder_input(109) <= encoder_output(0) xor encoder_output(7) xor encoder_output(123);
	...
	decoder_input(112) <= encoder_output(0) xor encoder_output(6) xor encoder_output(124);
	...
	decoder_input(115) <= encoder_output(0) xor encoder_output(5) xor encoder_output(125);
	...
	decoder_input(119) <= encoder_output(0) xor encoder_output(4) xor encoder_output(126);
	...
	decoder_input(122) <= encoder_output(0) xor encoder_output(3) xor encoder_output(127);
	...
	decoder_input(125) <= encoder_output(0) xor encoder_output(2) xor encoder_output(128);
