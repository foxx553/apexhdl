...
def main():
    ...
    # Init parser
    parser: ArgumentParser = argparse.ArgumentParser(description="FPGAEvaluator - A CLI Tool for Generating and Validating Unary and Binary Function Evaluators")

    # --- General ---
    gen: _ArgumentGroup = parser.add_argument_group("General")
    gen.add_argument("--method-name", required=True, help="Name of the circuit generation method")
    ...
    # --- Maths ---
    maths: _ArgumentGroup = parser.add_argument_group("Maths")
    ...
    # --- Generation ---
    build: _ArgumentGroup = parser.add_argument_group("Generation")
    ...
    # --- Software ---
    sw: _ArgumentGroup = parser.add_argument_group("Software")
    sw.add_argument("--simulation-tool", help="Software used for circuit simulation")
    sw.add_argument("--analysis-tool", help="Software used for circuit analysis")
    sw.add_argument("--analysis-mode", help="Whether the analysis is done post-synthesis or post-implementation")
    sw.add_argument("--implementation-tool", help="Software used for circuit implementation and bitstream generation")

    # --- Hardware ---
    hw: _ArgumentGroup = parser.add_argument_group("Hardware")
